...
from legged_gym.envs.kbot.kbot_config_ground import KbotCfg as KbotCfgGround
from legged_gym.envs.kbot.kbot_config_ground import KbotCfgPPO as KbotCfgPPOGround
...
task_registry.register( "kbot_ground", LeggedRobotGround, KbotCfgGround(), KbotCfgPPOGround())
